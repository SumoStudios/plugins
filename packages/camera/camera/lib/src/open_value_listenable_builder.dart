...
///
/// If the `child` parameter provided to the [OpenValueListenableBuilder] is not
...
/// See also:
///
///  * [OpenValueListenableBuilder], a widget which invokes this builder each time
...
/// [OpenValueListenableBuilder] will pass it back to your [builder] function so
...
/// {@tool snippet}
///
/// This sample shows how you could use a [OpenValueListenableBuilder] instead of
...
class OpenValueListenableBuilder<T> extends StatefulWidget {
  /// Creates a [OpenValueListenableBuilder].
  ///
  ...
  const OpenValueListenableBuilder(
    this._synchronizer, {
    Key? key,
  ...
  @override
  State<StatefulWidget> createState() => _OpenValueListenableBuilderState<T>();
}

class _OpenValueListenableBuilderState<T>
    extends State<OpenValueListenableBuilder<T>> {
  late T value;
  ...
  @override
  void didUpdateWidget(OpenValueListenableBuilder<T> oldWidget) {
    if (oldWidget.valueListenable != widget.valueListenable) {
      // Since this is very specific to the cameraController class.
      // The cameraController.dispose is handled very carefully in thi sapp.
      // hence it would be fairly safe to just comment this removeListener.
